...
ax.plot(x,sigma,'k-',label='initial condition')                   #plot of initial condition
evp, = ax.plot(x,sigma,'r',label='evolution over time')             #plot which will evolve over time
...
plt.xlabel('x')
plt.ylabel('Σ')
plt.title('Evolution of Σ for a viscous accretion disk')
plt.legend()
